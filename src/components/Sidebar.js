...
const Sidebar = () => {
    ...
    return (
        // ${dark ? 'navFooterDark' : 'navFooterLight'}
        <div className={`w-3/5 lg:w-1/6 h-[87vh] lg:h-[92vh] fixed top-[6vh] lg:top-[8vh] left-0 p-4 overflow-y-auto ${dark ? 'navFooterDark' : 'navFooterLight'}`}>
